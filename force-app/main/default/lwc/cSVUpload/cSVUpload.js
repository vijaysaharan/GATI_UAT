...
import COMPLAINT_CASES from '@salesforce/resourceUrl/Bulkfiledownload';
import { loadScript } from 'lightning/platformResourceLoader';
import csvDataHandler from '@salesforce/apex/CsvuploadController.csvDataHandler';
import { ShowToastEvent } from 'lightning/platformShowToastEvent';

export default class CSVUpload extends NavigationMixin(LightningElement) {
    ...
    columnsForResult = [
        ...
        {
            label :'Pickup Ref Number',
            fieldName : 'PickupRefNumber'
        },
        {
            label :'Status',
            fieldName : 'Status'
    ...
    downloadDummy(){
        ...
        window.open(baseUrl + COMPLAINT_CASES);
    }
    cancel(){
        this.rowsTotal = [];
        this.dataForResult = [];
