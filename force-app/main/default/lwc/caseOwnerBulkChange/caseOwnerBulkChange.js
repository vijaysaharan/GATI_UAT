...
import CHANGE_CASE_OWNER from '@salesforce/resourceUrl/BulkCaseOwnerChangeTemplate';
import { loadScript } from 'lightning/platformResourceLoader';
import CsvDataHandler from '@salesforce/apex/CaseOwnerBulkChangeController.csvDataHandler';
import { ShowToastEvent } from 'lightning/platformShowToastEvent';

export default class CaseOwnerBulkChange extends NavigationMixin(LightningElement) {
    ...
    downloadDummy(){
        ...
        window.open(baseUrl + CHANGE_CASE_OWNER);
    }
    ...
    handleSave(){
        ...
        CsvDataHandler({csvDataList : JSON.stringify(this.rowsTotal)}).then(res => {
            if(res){
                ...
                let data = ['CaseNumber','UserName','Message'];
    ...
    handleDownload(event){
        ...
        downloadElement.download = 'OwnerChange'+currentName+'.csv';
