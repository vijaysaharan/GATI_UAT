...
import CSVData from '@salesforce/apex/BulkAccountOwnerChange.csvData';
import { NavigationMixin } from 'lightning/navigation';
import { ShowToastEvent } from 'lightning/platformShowToastEvent';
import AccountOwnerChange from '@salesforce/resourceUrl/AccountOwnerChange';

var doc;
let dissave;
export default class AccountBulkOwnerChangeLWC extends NavigationMixin(LightningElement) {
    get records() {
        this.visiblerecords
    ...
    download(event) {
        ...
        window.open(baseUrl + AccountOwnerChange);
    ...
    handleSuccessLog() {
        ...
        doc += '<th>' + 'Customer_Category__c' + '</th>';
        doc += '<th>' + 'OwnerId' + '</th>';
        doc += '</tr>';
        ...
        this.dataresults.forEach(element => {
            if (element.done == true) {
                ...
                doc += '<td>' + element.obj.Customer_Category__c + '</td>';
                doc += '<td>' + element.obj.OwnerId + '</td>';
                doc += '</tr>';
            }
        });
