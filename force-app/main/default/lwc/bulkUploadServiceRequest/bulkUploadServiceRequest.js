...
import SERVICE_REQUESTS from '@salesforce/resourceUrl/serviceRequests';
import { loadScript } from 'lightning/platformResourceLoader';
import CsvDataHandler from '@salesforce/apex/BulkServiceRequests.CsvDataHandler';
import { ShowToastEvent } from 'lightning/platformShowToastEvent';
import {subscribe, unsubscribe, onError, setDebugFlag, isEmpEnabled } from 'lightning/empApi';

export default class BulkUploadServiceRequest extends NavigationMixin(LightningElement) {
    ...
    get isDataProcessed(){
        ...
        //return ((this.dataresults.length == this.rowsTotal.length) && (this.dataresults.length != 0)) ? true : false;
    }
    ...
    downloadDummy(){
        ...
        window.open(baseUrl + SERVICE_REQUESTS);
    }
    cancel(){
        this.rowsTotal = [];
        this.successList = '';
    ...
    handleSave(event){
        ...
        CsvDataHandler({csvDataList : JSON.stringify(this.rowsTotal)}).then(res => {
            ...
            if(res){
                ...
                let data = ['Type','Description','DocketNumber','Status','Message'];
