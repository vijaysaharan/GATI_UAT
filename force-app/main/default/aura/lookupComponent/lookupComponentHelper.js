	...
	itemSelected : function(component, event, helper) {
        ...
        if(SelIndex){
            ...
            if(selItem.val){
               ...
               component.set("v.selItem2",selItem);
               component.set("v.selectedValue",selItem.val);
                
               component.set("v.last_ServerResult",serverResult);
            } 
            component.set("v.server_result",null); 
            var cmpEvent = component.getEvent("fetchDebtorId");
    		cmpEvent.setParams({
        "debtorId": selItem.val
    	});
    	cmpEvent.fire();
        } 
	}, 
