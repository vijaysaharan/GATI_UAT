({
    ...
    handleSubmit:function(component,event,helper)
    {
        ...
        component.set("v.feedbackFields.Problem_solved_in_First_call__c",component.get("v.gatiselfcare"));
        component.set("v.feedbackFields.messages_instantly__c",component.get("v.problemsolved"));
        component.set("v.feedbackFields.customer_service_representative__c",component.get("v.timeconnecting"));
        ...
        console.log("Type " + component.get("v.feedbackFields.Type__c"));
